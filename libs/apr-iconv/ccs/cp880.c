...
static const iconv_ccs_convtable_8bit to_ucs = { {
	...
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0x0020, 0xFFFE, 0x0452, 0x0453, 0x0451, 0xFFFE, 0x0455, 0x0456,
	0x0457, 0x0458, 0x005B, 0x002E, 0x003C, 0x0028, 0x002B, 0x0021,
	0x0026, 0x0459, 0x045A, 0x045B, 0x045C, 0xFFFE, 0x045F, 0x042A,
	0x2116, 0x0402, 0x005D, 0x0024, 0x002A, 0x0029, 0x003B, 0x005E,
	0x002D, 0x002F, 0x0403, 0x0401, 0xFFFE, 0x0405, 0x0406, 0x0407,
	0x0408, 0x0409, 0x00A6, 0x002C, 0x0025, 0x005F, 0x003E, 0x003F,
	0x040A, 0x040B, 0x040C, 0xFFFE, 0xFFFE, 0x040F, 0x044E, 0x0430,
	0x0431, 0xFFFE, 0x003A, 0x0023, 0x0040, 0x0027, 0x003D, 0x0022,
	...
	0x044F, 0xFFFE, 0x0073, 0x0074, 0x0075, 0x0076, 0x0077, 0x0078,
...
static const iconv_ccs_convtable_8bit from_ucs_00 = { {
	...
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x00E1, 0xFFFE, 0x006A, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
...
static const iconv_ccs_convtable_8bit from_ucs_04 = { {
	0xFFFE, 0x0063, 0x0059, 0x0062, 0xFFFE, 0x0065, 0x0066, 0x0067,
	0x0068, 0x0069, 0x0070, 0x0071, 0x0072, 0xFFFE, 0xFFFE, 0x0075,
	0x00B9, 0x00BA, 0x00ED, 0x00BF, 0x00BC, 0x00BD, 0x00EC, 0x00FA,
	0x00CB, 0x00CC, 0x00CD, 0x00CE, 0x00CF, 0x00DA, 0x00DB, 0x00DC,
	0x00DE, 0x00DF, 0x00EA, 0x00EB, 0x00BE, 0x00CA, 0x00BB, 0x00FE,
	0x00FB, 0x00FD, 0x0057, 0x00EF, 0x00EE, 0x00FC, 0x00B8, 0x00DD,
	0x0077, 0x0078, 0x00AF, 0x008D, 0x008A, 0x008B, 0x00AE, 0x00B2,
	0x008F, 0x0090, 0x009A, 0x009B, 0x009C, 0x009D, 0x009E, 0x009F,
	0x00AA, 0x00AB, 0x00AC, 0x00AD, 0x008C, 0x008E, 0x0080, 0x00B6,
	0x00B3, 0x00B5, 0x00B7, 0x00B1, 0x00B0, 0x00B4, 0x0076, 0x00A0,
	0xFFFE, 0x0044, 0x0042, 0x0043, 0xFFFE, 0x0046, 0x0047, 0x0048,
	0x0049, 0x0051, 0x0052, 0x0053, 0x0054, 0xFFFE, 0xFFFE, 0x0056,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
...
static const iconv_ccs_convtable_8bit from_ucs_21 = { {
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x0058, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
