/*
 * Coded EBCDIC Character Set OSD_EBCDIC_DF04_15
...
static const iconv_ccs_convtable_8bit to_ucs = { {
	...
	0x00cc, 0x0161, 0x003a, 0x0023, 0x0040, 0x0027, 0x003d, 0x0022,
	...
	0x0153, 0x0178, 0x00ac, 0x005b, 0x005c, 0x005d, 0x017d, 0x00d7,
	0x00f9, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047,
	0x0048, 0x0049, 0x00ad, 0x00f4, 0x00f6, 0x00f2, 0x00f3, 0x00f5,
	0x0160, 0x004a, 0x004b, 0x004c, 0x004d, 0x004e, 0x004f, 0x0050,
...
static const iconv_ccs_convtable_8bit from_ucs_00 = { {
	...
	0x0041, 0x00aa, 0x00b0, 0x00b1, 0xFFFE, 0x00b2, 0xFFFE, 0x00b5,
	0xFFFE, 0x00b4, 0x009a, 0x008a, 0x00ba, 0x00ca, 0x00af, 0x00a1,
	0x0090, 0x008f, 0x00ea, 0x00fa, 0xFFFE, 0x00a0, 0x00b6, 0x00b3,
	0xFFFE, 0x00da, 0x009b, 0x008b, 0xFFFE, 0xFFFE, 0xFFFE, 0x00ab,
...
static const iconv_ccs_convtable_8bit from_ucs_01 = { {
	...
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0x00b7, 0x00b8, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0x00d0, 0x0079, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0x00b9, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x00be, 0x009d, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
...
static const iconv_ccs_convtable_8bit from_ucs_20 = { {
	...
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x009f, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
