...
static const iconv_ccs_convtable_7bit to_ucs = { {
	...
	0x0058, 0x0059, 0x005A, 0x00E2, 0x00E7, 0x00EA, 0x00C9, 0x005F,
...
static const iconv_ccs_convtable_8bit from_ucs_00 = { {
	...
	0x0048, 0x0049, 0x004A, 0x004B, 0x004C, 0x004D, 0x004E, 0x004F,
	0x0050, 0x0051, 0x0052, 0x0053, 0x0054, 0x0055, 0x0056, 0x0057,
	0x0058, 0x0059, 0x005A, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x005F,
	...
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0x005E, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0x0040, 0xFFFE, 0x005B, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x005C,
	0x007D, 0x007B, 0x005D, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x0060, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0x007C, 0xFFFE, 0x007E, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE
} };
