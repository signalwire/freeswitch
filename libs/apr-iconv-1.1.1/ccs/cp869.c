...
static const iconv_ccs_convtable_8bit to_ucs = { {
	...
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x0386, 0xFFFE,
	0x00B7, 0x00AC, 0x00A6, 0x2018, 0x2019, 0x0388, 0x2015, 0x0389,
	0x038A, 0x03AA, 0x038C, 0xFFFE, 0xFFFE, 0x038E, 0x03AB, 0x00A9,
...
static const iconv_ccs_convtable_8bit from_ucs_00 = { {
	...
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0x00FF, 0xFFFE, 0xFFFE, 0x009C, 0xFFFE, 0xFFFE, 0x008A, 0x00F5,
	0x00F9, 0x0097, 0xFFFE, 0x00AE, 0x0089, 0x00F0, 0xFFFE, 0xFFFE,
	0x00F8, 0x00F1, 0x0099, 0x009A, 0xFFFE, 0xFFFE, 0xFFFE, 0x0088,
...
static const iconv_ccs_convtable_8bit from_ucs_03 = { {
	...
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x00EF, 0x00F7, 0x0086, 0xFFFE,
	0x008D, 0x008F, 0x0090, 0xFFFE, 0x0092, 0xFFFE, 0x0095, 0x0098,
	0x00A1, 0x00A4, 0x00A5, 0x00A6, 0x00A7, 0x00A8, 0x00A9, 0x00AA,
	0x00AC, 0x00AD, 0x00B5, 0x00B6, 0x00B7, 0x00B8, 0x00BD, 0x00BE,
	0x00C6, 0x00C7, 0xFFFE, 0x00CF, 0x00D0, 0x00D1, 0x00D2, 0x00D3,
	0x00D4, 0x00D5, 0x0091, 0x0096, 0x009B, 0x009D, 0x009E, 0x009F,
...
static const iconv_ccs_convtable_8bit from_ucs_20 = { {
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x008E, 0xFFFE, 0xFFFE,
	0x008B, 0x008C, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
...
static const iconv_ccs_convtable_16bit from_ucs = { {
	&from_ucs_00, NULL, NULL, &from_ucs_03, NULL, NULL, NULL, NULL,
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	&from_ucs_20, NULL, NULL, NULL, NULL, &from_ucs_25, NULL, NULL,
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
