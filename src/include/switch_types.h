...
#define SWITCH_CHANNEL_EXECUTE_ON_ANSWER_VIDEO_VARIABLE "execute_on_answer_video"
#define SWITCH_CHANNEL_EXECUTE_ON_VIDEO_VARIABLE "execute_on_video"
...
#define SWITCH_CHANNEL_EXECUTE_ON_MEDIA_VIDEO_VARIABLE "execute_on_media_video"
...
typedef enum {
	...
	SWITCH_MESSAGE_INDICATE_REINVITE,
	SWITCH_MESSAGE_INDICATE_REINVITE_RESPOND,
...
typedef enum {
	...
	SWITCH_EVENT_CHANNEL_ROUTING,//added by fky for OS-13755,UC
	SWITCH_EVENT_SEND_EVENT,//added by yy for xfer three way,UC
	SWITCH_EVENT_ALL
...
typedef enum {
	...
	SWITCH_CAUSE_NO_DAIL_TONE = 35,//UC
	SWITCH_CAUSE_NO_TONE_AFTERDIAL = 36,//UC
...
typedef enum {
	...
	SCSC_RTP_START_PORT,//UC
	SCSC_RTP_END_PORT,//UC
	SCSC_RTP_FVF,//UC
	SCSC_WRITE_VIDEO_WH,//UC
